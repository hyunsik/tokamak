...
# Copyright (c) 2015 Hyunsik Choi (hyunsik.choi at gmail dot com).
#
...
# It is borrowed from rust/src/etc/platform-intrinsics/generator.py.
...
// DO NOT EDIT: autogenerated by platform-intrinsics/generator.py
// ignore-tidy-linelength

#![allow(unused_imports)]

use super::{{Intrinsic, i, i_, u, u_, f, v, v_, agg, p, void}};
use super::IntrinsicDef::Named;

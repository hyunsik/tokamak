...
impl AssocOp {
    ...
    pub fn from_token(t: &Token) -> Option<AssocOp> {
        ...
        match *t {
            ...
            Token::BinOp(BinOpToken::LShift) => Some(ShiftLeft),
            Token::BinOp(BinOpToken::RShift) => Some(ShiftRight),
    ...
    pub fn from_ast_binop(op: BinOpKind) -> Self {
        ...
        match op {
            ...
            BinOpKind::LShift => ShiftLeft,
            BinOpKind::RShift => ShiftRight,
    ...
    pub fn to_ast_binop(&self) -> Option<BinOpKind> {
        ...
        match *self {
            ...
            ShiftLeft => Some(BinOpKind::LShift),
            ShiftRight => Some(BinOpKind::RShift),
